...
Config.LeaveMarker = true --if this true then a marker spawns at the point where the player leaved
...
Config.Kicks = 10
Config.WarnBan = true --if this true then players whit 3 warns will banned
Config.Warns = 3
Config.Whitelist = true --if this true then players whitout whitelist will kick from the server
...
Config.use_logs = false
Config.webhookURL = '' --if Config.use_logs == true then paste yout Discord Webhook-URL here
Config.use_cutom_logs = false
function cutom_logs(type, message) --if Config.use_cutom_logs == true then paste yout log system here
